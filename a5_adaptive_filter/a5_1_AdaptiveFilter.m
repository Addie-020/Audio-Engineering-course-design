...
%
% Adaptive function of active noise cancelling (LMS algorithm)
%
% Input arguments:
%   @xRef : Current input of reference channel signal
%   @xPrim: Current input of primary channel signal
